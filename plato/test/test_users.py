...
class TestUserService(BaseTestCase):
    ...
    def test_single_user(self):
        ...
        user = add_user(username='michael', email='michael@realpython.com', password='test_pwd')
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('michael', 'michael_foo@realpython.com', 'test_pwd')
        add_user('fletcher', 'fletcher_foo@realpython.com', 'test_pwd', created_at)
        with self.client:
